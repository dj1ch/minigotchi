...
###
**Note that I have merged changes from development recently as to fix a recent pull request made to this repository. Use the latest [release](/releases), so there are no problems. I am working constantly to figure out everything and to push a new release soon.**
#### Intro
