...
public:
    ...
    static void sendPwnagotchiStatus(parasite_pwnagotchi_scan_type_t status, const char *frd);
    static void sendDeauthStatus(parasite_deauth_status_type_t status);
    static void sendDeauthStatus(parasite_deauth_status_type_t status, const char *target, int channel);
    static int channel;
private:
